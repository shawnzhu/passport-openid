...
Strategy.prototype.authenticate = function(req, options) {
  ...
  //console.log("HNS request %j", req);
  //console.log("HNS options %j", options);
  console.log("HNS myOptions %j", options);
...
Strategy.prototype._parseProfileExt = function(params) {
  ...
  console.log("HNS params %j", params);
